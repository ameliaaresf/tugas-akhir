<nav aria-label="alternative nav">
            <div class="bg-blue-500 h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48 content-center">
                ...
                <div class="md:mt-12 md:w-48 md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul class=" flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1 hover:bg-blue-600 px-1 rounded-lg ">
                            <a href="/admin" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline ">
                        ...
                        <li class="mr-3 flex-1 hover:bg-blue-600 px-1 rounded-lg">
                            <a href="{{ route ('admin.data-penduduk.index')}}" class="block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline ">
                        ...
                        <li class="mr-3 flex-1 hover:bg-blue-600 px-1 rounded-lg">
                            <a href="{{ route ('admin.surat-menyurat.index')}}" class="block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline ">
