...
<div class = "bg-gray-100 w-full mx-4 rounded-lg">
    ...
    <form class="w-full mt-10 px-4 rounded-lg" action="{{route('admin.skt.store')}}" method = "post">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('nama_lembaga') ? 'is-invalid' : ''}}" id="nama_lembaga" name = "nama_lembaga" type="text" placeholder="Masukkan nama_lembaga">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('desa') ? 'is-invalid' : ''}}" id="desa" name = "desa" type="text" placeholder="Masukkan desa">
          @if($errors->has('desa'))
          <div class="text-red-600 italic "> 
          {{$errors->first('desa')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('kec') ? 'is-invalid' : ''}}" id="kec" name = "kec" type="text" placeholder="Masukkan kec">
          @if($errors->has('kec'))
          <div class="text-red-600 italic "> 
          {{$errors->first('kec')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('kab') ? 'is-invalid' : ''}}" id="kab" name = "kab" type="text" placeholder="Masukkan kab">
          @if($errors->has('kab'))
          <div class="text-red-600 italic "> 
          {{$errors->first('kab')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('utara') ? 'is-invalid' : ''}}" id="utara" name = "utara" type="text" placeholder="Masukkan utara">
          @if($errors->has('utara'))
          <div class="text-red-600 italic "> 
          {{$errors->first('utara')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('timur') ? 'is-invalid' : ''}}" id="timur" name = "timur" type="text" placeholder="Masukkan timur">
          @if($errors->has('timur'))
          <div class="text-red-600 italic "> 
          {{$errors->first('timur')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('selatan') ? 'is-invalid' : ''}}" id="selatan" name = "selatan" type="text" placeholder="Masukkan selatan">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('barat') ? 'is-invalid' : ''}}" id="barat" name = "barat" type="text" placeholder="Masukkan barat">
          @if($errors->has('barat'))
          <div class="text-red-600 italic "> 
          {{$errors->first('barat')}}
          </div>
