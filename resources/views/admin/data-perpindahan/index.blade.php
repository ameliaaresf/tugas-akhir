...
@section('content')
		...
		<h1 class="text-3xl py-4 border-b mb-10 text-white">Data Perpindahan</h1>
			...
			<div>
                <div class="">
                    <div class="rounded bg-green-500 hover:bg-green-700 py-2 px-4 text-white mr-5">
                        <a href="{{ route('admin.data-perpindahan.create')}}">Tambah</a>
                    </div>
		...
		<div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative"
			...
			<table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
				...
				<tbody>
						...
						@foreach ($dataperpindahan as $data)
						<tr>
							...
							<td class="border border-slate-300 border-t border-gray-200 userId text-center">
							{{ date("d F Y", strtotime($data->tgl_pindah))}}
							</td>
							<td class="border border-slate-300 border-t border-gray-200 userId text-center">
							{{$data->jk}}
							</td>
							...
							<td class="border border-slate-300 border-t border-gray-200 userId text-center">
							<a href="{{url('admin/data-perpindahan')}}/{{$data->id}}/{{'edit'}}" class='btn btn-success btn-sm'><i class='fas fa-pencil-alt'></i></a>
							<form action="{{url('admin/data-perpindahan')}}/{{$data->id}}" method = "post">
							@method('DELETE')
							@csrf
							<button type = "submit">
