...
@section('content')
		...
		<h1 class="text-3xl py-4 border-b mb-10 text-white">Data Perceraian</h1>
			...
			<div>
                <div class="">
                    <div class="rounded bg-green-500 hover:bg-green-700 py-2 px-4 text-white mr-5">
                        <a href="{{ route('admin.data-perceraian.create')}}">Tambah</a>
                    </div>
		...
		<div class="overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative"
			...
			<table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
				...
				<tbody>
						...
						@foreach ($dataperceraian as $data)
						<tr>
							...
							<form action="{{url('admin/data-perceraian')}}/{{$data->id}}" method = "post">
							@method('DELETE')
							@csrf
							<button type = "submit">
