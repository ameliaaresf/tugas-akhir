...
<div class = "bg-gray-100 w-full mx-4 rounded-lg">
    ...
    <form class="w-full mt-10 px-4 rounded-lg" action="{{route('admin.skd.update', $skd->id)}}" method = "post">
    @method('PUT')    
    @csrf
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          {{ $errors ->has('no_regis') ? 'is-invalid' : ''}}" id="no_regis" name = "no_regis" type="text" placeholder="Masukkan Nomor Registrasi" value="{{old('no_regis' , $skd->no_regis)}}">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('nama') ? 'is-invalid' : ''}}" id="nama" name = "nama" type="text" placeholder="Masukkan Nama" value="{{old('nama' , $skd->nama)}}">
          @if($errors->has('nama'))
          <div class="text-red-600 italic "> 
          {{$errors->first('nama')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('nik') ? 'is-invalid' : ''}}" id="nik" name = "nik" type="text" placeholder="Masukkan NIK" value="{{old('nik' , $skd->nik)}}">
          @if($errors->has('nik'))
          <div class="text-red-600 italic "> 
          {{$errors->first('nik')}}
          </div>
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('tempat_lahir') ? 'is-invalid' : ''}}" id="tempat_lahir" name = "tempat_lahir" type="text" placeholder="Masukkan Tempat Lahir" value="{{old('tempat_lahir' , $skd->tempat_lahir)}}">
          <!-- <p class="text-red-500 text-xs italic">Please fill out this field.</p> -->
        ...
        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="cus_name">Tanggal Lahir</label>
            <div class="relative">
                ...
                <input id="tgl_lahir" datepicker="" value="{{old('tgl_lahir' , $skd->tgl_lahir)}}" datepicker-format="yyyy/mm/dd" type="text" name="tgl_lahir" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 {{ $errors ->has('tgl_lahir') ? 'is-invalid' : ''}} " placeholder="Pilih Tanggal">
  ...
  <div class="flex items-center mr-4 mb-4">
    <input id="laki-laki" type="radio" name="jk" class="hidden {{ $errors ->has('jk') ? 'is-invalid' : ''}}" value = "Laki-laki" {{ ($skd->jk=="Laki-laki")? "checked" : "" }} />
   ...
   <div class="flex items-center mr-4 mb-4">
    <input id="perempuan" type="radio" name="jk" class="hidden {{ $errors ->has('jk') ? 'is-invalid' : ''}}" value = "Perempuan" {{ ($skd->jk=="Perempuan")? "checked" : "" }} />
    <label for="perempuan" class="flex items-center cursor-pointer">
     ...
     @if($errors->has('jk'))
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('pekerjaan') ? 'is-invalid' : ''}}" id="pekerjaan" name = "pekerjaan" type="text" placeholder="Masukkan Pekerjaan" value="{{old('pekerjaan' , $skd->pekerjaan)}}">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <div class="flex items-center mr-4 mb-4">
    <input id="wni" type="radio" name="kw" class="hidden {{ $errors ->has('kw') ? 'is-invalid' : ''}}" value = "WNI" {{ ($skd->jk=="WNI")? "checked" : "" }} />
   ...
   <div class="flex items-center mr-4 mb-4">
    <input id="wna" type="radio" name="kw" class="hidden {{ $errors ->has('kw') ? 'is-invalid' : ''}}" value = "WNA" {{ ($skd->jk=="WNA")? "checked" : "" }} />
