    ...
    <form class="w-full mt-10 px-4 rounded-lg" action="{{route('admin.data-kelahiran.store')}}" method = "post">
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 
          {{ $errors ->has('nama_bayi') ? 'is-invalid' : ''}}" id="nama_bayi" name = "nama_bayi" type="text" placeholder="Masukkan Nama Bayi">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 {{ $errors ->has('nama_ayah') ? 'is-invalid' : ''}}" id="nama_ayah" name = "nama_ayah" type="text" placeholder="Masukkan Nama Ayah">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 {{ $errors ->has('nama_ibu') ? 'is-invalid' : ''}}" id="nama_ibu" name = "nama_ibu" type="text" placeholder="Masukkan Nama Ibu">
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 {{ $errors ->has('tempat_lahir') ? 'is-invalid' : ''}}" id="tempat_lahir" name = "tempat_lahir" type="text" placeholder="Masukkan Tempat Lahir">
          <!-- <p class="text-red-500 text-xs italic">Please fill out this field.</p> -->
        ...
        <div class="w-full px-3 mb-6 md:mb-0 my-4">
          ...
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 {{ $errors ->has('jam_lahir') ? 'is-invalid' : ''}}" id="jam_lahir" name="jam_lahir" type="time" placeholder="Masukkan Tempat Lahir">
          <!-- <p class="text-red-500 text-xs italic">Please fill out this field.</p> -->
