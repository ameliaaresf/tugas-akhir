...
<div class = "bg-gray-100 w-full mx-4 rounded-lg">
  ...
  <div class="mb-3 xl:w-96 relative">
    <select class="form-select appearance-none
      ...
      ease-in-out
      m-0
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none {{ $errors ->has('keterangan') ? 'is-invalid' : ''}}" id = "keterangan" name = "keterangan" aria-label="Default select example">
        <option selected>Masukkan Keterangan</option>
        <option value="Belum Vaksin">Belum Vaksin</option>
        <option value="Vaksin Dosis Pertama">Vaksin Dosis Pertama</option>
        <option value="Vaksin Dosis Kedua">Vaksin Dosis Kedua</option>
        <option value="Vaksin Dosis Ketiga">Vaksin Dosis Ketiga</option>
    </select>
