...
@section('content')
		...
		<h1 class="text-3xl py-4 border-b mb-10 text-white">Data Pekerja Migran</h1>
			...
			<div>
				<div class="">
                    <div class="rounded bg-green-500 hover:bg-green-700 py-2 px-4 text-white mr-5">
                        <a href="{{ route('admin.data-pekerja-migran.create')}}">Tambah</a>
                    </div>
			...
			<table class="border-collapse border border-slate-400 table-auto w-full whitespace-no-wrap bg-white table-striped relative">
				...
				<tbody>
						...
						<tr>
							...
							<td class="border border-slate-300 border-t border-gray-200 userId text-center">
							<a href="{{url('admin/data-pekerja-migran')}}/{{$data->id}}/{{'edit'}}" class='btn btn-success btn-sm'><i class='fas fa-pencil-alt'></i></a>
							<form action="{{url('admin/data-pekerja-migran')}}/{{$data->id}}" method = "post">
							@method('DELETE')
							@csrf
							<button type = "submit">
